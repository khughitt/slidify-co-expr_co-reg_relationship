...
```{r abutte_refs, include=FALSE}
library(knitcitations)
cleanbib()
citep('10.1006/jbin.2002.1037')
citep('10.1371/journal.pcbi.1002375')
```
...
```{r abutte_refs_output, echo=FALSE, results='asis'}
bibliography('html')
```
